...
export function recordToTeableFields(record, year) {
  ...
  return {
    ...
    [TEABLE_FIELDS.handoverAmilName]: record.handoverAmilName || record.handoverImaeFatemaName || "",
    [TEABLE_FIELDS.takeoverAmilName]: record.takeoverAmilName || record.takeoverImaeFatemaName || "",
...
export function teableRecordToSchedule(record) {
  ...
  return {
    ...
    handoverImaeFatemaName: fields[TEABLE_FIELDS.handoverImaeFatemaName] || fields[TEABLE_FIELDS.handoverAmilName] || "",
    takeoverImaeFatemaName: fields[TEABLE_FIELDS.takeoverImaeFatemaName] || fields[TEABLE_FIELDS.takeoverAmilName] || "",
    handoverAmilName: fields[TEABLE_FIELDS.handoverAmilName] || fields[TEABLE_FIELDS.handoverImaeFatemaName] || "",
    takeoverAmilName: fields[TEABLE_FIELDS.takeoverAmilName] || fields[TEABLE_FIELDS.takeoverImaeFatemaName] || "",
